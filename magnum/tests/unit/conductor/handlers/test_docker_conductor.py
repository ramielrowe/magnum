...
class TestDockerConductor(base.BaseTestCase):
    ...
    def test_docker_for_bay(self, mock_docker_client):
        ...
        actual_docker = self.conductor.docker_for_bay(mock_bay)
    ...
    def test_docker_for_container(self, mock_bay_get_by_uuid,
                                  mock_docker_client):
        mock_docker = mock.MagicMock()
        mock_docker_client.DockerHTTPClient.return_value = mock_docker
        ...
        mock_contianer = mock.MagicMock()
        mock_contianer.bay_uuid = 'some_uuid'

        actual_docker = self.conductor.docker_for_container(
    ...
    def test_docker_for_container_uuid(self, mock_container_get_by_uuid,
        ...
        mock_contianer = mock.MagicMock()
        mock_contianer.bay_uuid = 'bay_uuid'
        mock_container_get_by_uuid.return_value = mock_contianer

        actual_docker = self.conductor.docker_for_container_uuid(
                                                mock.sentinel.context,
                                                'container_uuid')
    ...
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container')
    def test_container_create(self, mock_docker_for_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container.return_value = mock_docker
    ...
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container')
    def test_container_create_with_command(self, mock_docker_for_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container.return_value = mock_docker
    ...
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container')
    def test_container_create_with_failure(self, mock_docker_for_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container.return_value = mock_docker
        mock_container = mock.MagicMock()
        mock_container.image_id = 'test_image:some_tag'
    ...
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_delete(self, mock_docker_for_container_uuid,
                              mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
    ...
    def test_container_delete_with_container_not_exist(self,
                                        mock_docker_for_container_uuid,
                                        mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_reboot(self, mock_docker_for_container_uuid,
                              mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_start(self, mock_docker_for_container_uuid,
                             mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_stop(self, mock_docker_for_container_uuid,
                            mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_stop_with_failure(self, mock_docker_for_container_uuid,
                                         mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_pause(self, mock_docker_for_container_uuid,
                             mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_pause_with_failure(self, mock_docker_for_container_uuid,
                                          mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_unpause(self, mock_docker_for_container_uuid,
                               mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_show(self, mock_docker_for_container_uuid,
                            mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_show_with_failure(self, mock_docker_for_container_uuid,
                                         mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_execute(self, mock_docker_for_container_uuid,
                               mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_logs(self, mock_docker_for_container_uuid,
                            mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
    ...
    @patch.object(docker_conductor.Handler, '_find_container_by_name')
    @mock.patch.object(docker_conductor.Handler, 'docker_for_container_uuid')
    def test_container_logs_with_failure(self, mock_docker_for_container_uuid,
                                         mock_find_container):
        mock_docker = mock.MagicMock()
        mock_docker_for_container_uuid.return_value = mock_docker
        mock_container_uuid = 'd545a92d-609a-428f-8edb-16b02ad20ca1'
