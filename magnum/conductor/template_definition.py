...
def get_template_definitions():
    ...
    get_template_definitions will return:
        {
            (platform1, os1, coe1): {'template_name_1': TemplateDefinition1},
            (platform2, os2, coe2): {'template_name_2': TemplateDefinition2}
        }
    ...
    if not DEFINITION_MAP:
        DEFINITION_MAP = dict()
        for entry_point, cls in load_entry_points():
...
def get_template_definition(platform, os, coe):
    '''Returns the enabled TemplateDefinition class for the provided bay_type.
    ...
    definition_map = get_template_definitions()
...
class K8sTemplateDefinition(TemplateDefinition):
    provides = [
    ...
    def __init__(self):
        ...
        self.add_output('node_addresses', 'kube_minions_external')
