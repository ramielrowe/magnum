...
class Handler(object):
    ...
    def container_delete(self, context, container_uuid):
        ...
        docker = self.docker_for_container_uuid(context, container_uuid)
        try:
