...
def _docker_for_container(context, container):
    ...
    yield docker_client.DockerHTTPClient(
        ...
        client_key=magnum_key.name,
        client_cert=magnum_cert.name
    )
...
class Handler(object):
    ...
    def container_create(self, context, container):
        with _docker_for_container(context, container) as docker:
            name = container.name
    ...
    def container_delete(self, context, container_uuid):
        ...
        with _docker_for_container(context, container_uuid) as docker:
            try:
